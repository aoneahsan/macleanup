...
> the most common ones in one command each. Then upgrade to **`4.5.0`**
...
```bash
npx macleanup@latest --version    # confirm 4.5.0 (or newer)
...
Once you've upgraded to **4.5.0** (or any 4.3.1+), the safety changes
...
_Recovery guide for **mac-cleanup** v4.5.0 by **[Ahsan Mahmood](author.md)**._
